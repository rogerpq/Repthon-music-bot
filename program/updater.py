...
async def update_repo(_, message: Message):
    ...
    msg = await message.reply("🔄 `تتم البرمجه بواسطة سورس ريبثون )
    ...
    if update_avail:
        ...
        return
    await msg.edit(f"تم الترقية بواسطه سورس [𝐑𝐄𝐏𝐓𝐇𝐎𝐍™ ريبثون ](https://t.me/roger21v)", disable_web_page_preview=True)
